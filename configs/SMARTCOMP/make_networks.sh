...
netgenerate --grid --grid.number=3 --grid.length=100 --no-turnarounds -j=traffic_light --output=configs/SMARTCOMP/grid-3x3.net.xml --grid.attach-length=100 -L=2  #Yingfan



netgenerate --grid --grid.number=3 --grid.length=100 --no-turnarounds -j=traffic_light --output=grid-3x3.net.xml --grid.attach-length=100 -L=2  #Yingfan 20260212


netgenerate --grid --grid.number=5 --grid.length=100 --no-turnarounds -j=traffic_light --output=grid-5x5.net.xml --grid.attach-length=100 -L=2  #Yingfan 20260212


netgenerate --grid --grid.number=7 --grid.length=100 --no-turnarounds -j=traffic_light --output=grid-7x7.net.xml --grid.attach-length=100 -L=2  #Yingfan 20260212
